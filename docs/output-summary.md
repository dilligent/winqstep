...
per-atom force table. When file-generating print controls such as PDOS, cube,
or band-structure output produce recognized outputs, the result summary also
lists `files.generated` entries.
