...
class GuiPrototypeTests(unittest.TestCase):
    ...
    def test_button_smoke_can_raise_common_click_handlers(self) -> None:
        ...
        self.assertTrue(report["artifact_summary_has_scf"])
        self.assertTrue(report["artifact_summary_has_cell"])
        self.assertTrue(report["artifact_summary_has_walltime"])
        self.assertTrue(report["artifact_results_has_force_table"])
        self.assertTrue(report["artifact_results_has_scf"])
        self.assertTrue(report["artifact_results_has_cell"])
        self.assertTrue(report["artifact_results_has_walltime"])
        ...
        self.assertTrue(report["result_summary_file_has_scf"])
        self.assertTrue(report["result_summary_file_has_cell"])
