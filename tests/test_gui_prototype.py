...
class GuiPrototypeTests(unittest.TestCase):
    def test_run_button_is_wired_to_async_job_launcher(self) -> None:
        ...
        self.assertIn('x:Name="FallbackPeriodicBox" Grid.Row="6" Grid.Column="3" IsEditable="True"', xaml_text)
        self.assertIn('<ComboBoxItem Content="NONE"/>', xaml_text)
        self.assertIn('x:Name="FallbackCellABox" Grid.Row="7" Grid.Column="1" IsEditable="True"', xaml_text)
        self.assertIn('x:Name="FallbackCellBBox" Grid.Row="7" Grid.Column="3" IsEditable="True"', xaml_text)
        self.assertIn('x:Name="FallbackCellCBox" Grid.Row="8" Grid.Column="1" IsEditable="True"', xaml_text)
        self.assertIn('x:Name="CenterAtomsBox"', xaml_text)
        self.assertIn('x:Name="KindEntriesGrid"', xaml_text)
        self.assertIn('x:Name="KindsText" Grid.Row="9" Grid.Column="0" Grid.ColumnSpan="4" Visibility="Collapsed"', xaml_text)
        self.assertIn('x:Name="DataLabelsGrid" Grid.Row="10" Grid.Column="0" Grid.ColumnSpan="4"', xaml_text)
    ...
    def test_wpf_smoke_test_loads_window(self) -> None:
        ...
        self.assertEqual(report["template_combo_fields_loaded"], 17)
        self.assertEqual(report["template_combo_fields_editable"], 17)
