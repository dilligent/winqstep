...
class GuiPrototypeTests(unittest.TestCase):
    def test_run_button_is_wired_to_async_job_launcher(self) -> None:
        ...
        self.assertIn('x:Name="KindsText" Grid.Row="7" Grid.Column="0" Grid.ColumnSpan="4" Visibility="Collapsed"', xaml_text)
        self.assertIn('x:Name="DataLabelsGrid" Grid.Row="8" Grid.Column="0" Grid.ColumnSpan="4"', xaml_text)
    ...
    def test_wpf_smoke_test_loads_window(self) -> None:
        ...
        self.assertEqual(report["template_combo_fields_loaded"], 13)
        self.assertEqual(report["template_combo_fields_editable"], 13)
